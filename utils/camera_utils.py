...
class Camera(nn.Module):
    ...
    def compute_grad_mask(self, config):
        ...
        # get gray image
        gray_img = self.original_image.mean(dim=0, keepdim=True) # shape: [1, H, W]

        # get vertical and horizontal edge map
        gray_grad_v, gray_grad_h = image_gradient(gray_img)

        # find the true silhouette mask
